/*
 * arch/arm/plat-ambarella/boss/timer.c
 *
 * History:
 ...
 * Timer 4 is used as clock_event_device.
 * Timer 5 is used as free-running clocksource
...
/* ==========================================================================*/
#ifdef CONFIG_AMBARELLA_SUPPORT_CLOCKSOURCE
#define AMBARELLA_CS_TIMER_STATUS_REG		TIMER5_STATUS_REG
#define AMBARELLA_CS_TIMER_RELOAD_REG		TIMER5_RELOAD_REG
#define AMBARELLA_CS_TIMER_MATCH1_REG		TIMER5_MATCH1_REG
#define AMBARELLA_CS_TIMER_MATCH2_REG		TIMER5_MATCH2_REG
#define AMBARELLA_CS_TIMER_CTR_EN		TIMER_CTR_EN5
#define AMBARELLA_CS_TIMER_CTR_OF		TIMER_CTR_OF5
#define AMBARELLA_CS_TIMER_CTR_CSL		TIMER_CTR_CSL5
#define AMBARELLA_CS_TIMER_CTR_MASK		0x000F0000
