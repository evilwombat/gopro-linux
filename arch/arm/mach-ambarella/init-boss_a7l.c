...
/* ==========================================================================*/
static void __init ambarella_init_a7l_bub(void)
{
	int					i;

	ambarella_init_machine("A7L_BUB");
...
#if defined(CONFIG_PLAT_AMBARELLA_A7L_EVK_BOSS)
...
/* ==========================================================================*/
MACHINE_START(AMBARELLA, "A7L_BUB_Boss")
	...
	.init_machine	= ambarella_init_a7l_bub,
MACHINE_END
