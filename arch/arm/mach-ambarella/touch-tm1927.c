/*
 * arch/arm/mach-ambarella/touch-tm1927.c
 *
...
/* ==========================================================================*/
static int ambarella_tm1927_get_pendown_state(void)
{
...
static void ambarella_tm1927_clear_penirq(void)
{
...
static int ambarella_tm1927_init_platform_hw(void)
{
...
static void ambarella_tm1927_exit_platform_hw(void)
{
}

static struct tm1927_platform_data ambarella_tm1927_pdata = {
	.fix = {
		[TM1927_FAMILY_0] = {
			.x_invert	= 0,
			.y_invert	= 0,
	...
	.get_pendown_state	= ambarella_tm1927_get_pendown_state,
	.clear_penirq		= ambarella_tm1927_clear_penirq,
	.init_platform_hw	= ambarella_tm1927_init_platform_hw,
	.exit_platform_hw	= ambarella_tm1927_exit_platform_hw
};

struct i2c_board_info ambarella_tm1927_board_info = {
	.type		= "tm1927",
	.addr		= 0x22,
	.platform_data	= &ambarella_tm1927_pdata,
};
